 ...
 */
public class CustomAnalog extends View {
    ...
    public CustomAnalog(Context context) {
        super(context);
        init();
    }

    public CustomAnalog(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomAnalog(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        circlePaint2.setColor(Color.YELLOW);
        circlePaint2.setColor(Color.parseColor("#C2185B"));
        circlePaint2.setStyle(Paint.Style.FILL);
        linePaint = new Paint();
//        linePaint.setColor(EqualizerFragment.themeColor);
        linePaint.setColor(Color.parseColor("#00FF7F"));
...
//            circlePaint.setColor(Color.parseColor("#111111"));
            circlePaint.setColor(Color.parseColor("#F6E88A06"));
        ...
        circlePaint.setColor(Color.parseColor("#DC143C"));
